...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
        <div className='absolute border border-[#ffffff] opacity-20 rounded-full h-[200px] w-[200px] mt-52 animate-ping'/>
        ...
        <div className='rounded-full border border-[#33FF58] opacity-50 h-[650px] w-[650px] absolute mt-52 animate-pulse'/>
